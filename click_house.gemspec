...
Gem::Specification.new do |spec|
  ...
  spec.authors       = ['Nikita Sokolov']
  spec.email         = ['faucct@gmail.com']

  spec.summary       = 'Minimalistic ClickHouse DB adapter'
  spec.homepage      = 'https://github.com/faucct/click_house'
  spec.license       = 'MIT'
